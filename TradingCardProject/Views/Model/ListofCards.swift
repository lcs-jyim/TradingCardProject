...
//  TradingCardProject
//
//  Created by junxi Yim on 2024/2/2.
//
...
let Twistzz = CardView(Age: 24, KPR: 0.68, Surviving: "37%", ADR: 74.3, Impact: 1.03, KAST: "73.7%", Rating: 1.10, PlayName: "Russel \"Twistzz\" Van Dulken",PlayNameShort: "\"Twistzz\"", PlayerIntroduction: """
...
""",PlayerTeamLogo: "fazelogo",PlayerSignatureLogo: "twistzzSticker", playerImage: "Twistzz",Discription: "The Best Hair among all players")

let Rain = CardView(Age: 29, KPR: 0.71, Surviving: "31%", ADR: 79.6, Impact: 1.16, KAST: "69.9", Rating: 1.02, PlayName: "Håvard \"rain\" Nygaard",PlayNameShort: "\"rain\"" ,PlayerIntroduction: """
...
""", PlayerTeamLogo: "fazelogo", PlayerSignatureLogo: "rainSticker", playerImage: "raincs",Discription: "The Great leader,the King of an age")

let Broky = CardView(Age: 22, KPR: 0.73, Surviving: "39%", ADR: 73.9, Impact: 1.04, KAST: "74.0%", Rating: 1.13, PlayName:" Helvijs \"⁠broky\" Saukants",PlayNameShort: "\"broky\"", PlayerIntroduction: """
...
""", PlayerTeamLogo: "fazelogo", PlayerSignatureLogo: "brokySticker", playerImage: "broky",Discription: "The young blood of FaZe Clan, Top 10 in the world")

let Ropz = CardView(Age: 24, KPR: 0.75, Surviving: "39%", ADR: 80.0, Impact: 1.23, KAST: "73.2%", Rating: 1.17, PlayName: "Robin \"⁠ropz⁠\" Kool",PlayNameShort: "\"ropz\"", PlayerIntroduction: """
...
""", PlayerTeamLogo: "fazelogo", PlayerSignatureLogo: "ropzSticker", playerImage: "ropz",Discription: "The Best Rifler in the Whole World")

let Frozen = CardView(Age: 21, KPR: 0.72, Surviving: "42%", ADR: 80.8, Impact: 1.11, KAST: "75.3%", Rating: 1.19, PlayName: "David \"⁠frozen⁠\" Čerňanský",PlayNameShort: "\"frozen\"", PlayerIntroduction: """
...
""", PlayerTeamLogo: "Mouz Logo", PlayerSignatureLogo: "FROZEN", playerImage: "FrozenImage",Discription: "The one who always bring Miracles to the Compitition")
